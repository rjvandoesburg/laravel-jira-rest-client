...
trait PropertiesRequests
{
     ...
     *
     * @see https://developer.atlassian.com/cloud/jira/platform/rest/v3/#api-rest-api-3-issue-issueIdOrKey-properties-get
     *
     ...
     *
     * @see https://developer.atlassian.com/cloud/jira/platform/rest/v3/#api-rest-api-3-issue-issueIdOrKey-properties-propertyKey-get
     *
     * @param  string|int  $issueIdOrKey
     ...
     *
     * @see https://developer.atlassian.com/cloud/jira/platform/rest/v3/#api-rest-api-3-issue-issueIdOrKey-properties-propertyKey-put
     *
     * @param  string|int  $issueIdOrKey
     * @param  string  $propertyKey
     */
     ...
     *
     * @see https://developer.atlassian.com/cloud/jira/platform/rest/v3/#api-rest-api-3-issue-issueIdOrKey-properties-propertyKey-delete
     *
     * @param  string|int  $issueIdOrKey
     * @param  string  $propertyKey
     */
